...
// Sempre que criamos um estado para um array ou objeto: manualmente informar o tipo da variavel
...
const CreatePoint = () => {
    ...
    // A funcao vai ser executada uma unica vez qnd o componente for executado
    useEffect(() => {
